...
\begin{frame}{Xducer semantics} \footnotesize
	\begin{itemize}
		\item General semantics, \boxed{\sevalf{\a_1}{\a_k}{\c}{\a}}\\
		\begin{itemize}
		\item 
		 \PT{
	...
	\item Specific semantics (part), \boxed{\blocke{\a_1}{\a_k}{\a}} : \\	
		\PT{
...
%\begin{itemize}
%	\item More scalar types, pairs/tuples or built-in operations: should be easy to support conceptually
%	\item Restricted comprehension: similar to the general one, but need to take care of packing general types 
%	\item Step/space cost: somehow similar to work cost
...
%	\item Error preservation: possible to support in principle 
