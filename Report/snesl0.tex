...
\PT{ \Axiom{\usum(\oF) \dda \singl\unit}}
...
\def\usumdef{\sdef{\s_0}{\usum(\s_2)}} 
	...
	From the rules $\PName{UsumF}$ and $\PName{UsumT}$ we know that $\b_1$ must end with (and include exact) one $\T$ so that $\MP_0'$ can terminate. 
