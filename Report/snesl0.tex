...
\PRule{Empty}{\PT{\Axiom{\seval{\epsilon}{\sgm}{\c}{\sgm}}}}
...
\PRule{Wc-Emp}{\PT{
	...
	\UC{\seval{\withctrl{\s}{p}{\st}}{\sgm}{\c}{\sgm[\s_1 \|-> \emptyv, ..., \s_i \|-> \emptyv]}}
}}\\[2ex]
...
\PRule{Wc-Nonemp}{\PT{
	...
	\RiLa{\left(
		...
		&\sids{\st}=\{s_1,...,s_i\}
		\end{aligned}\right)}
	\UC{\seval{\withctrl s p \st } \sgm {\c} \sgm[\s_1 \|-> \sgm''(\s_1),...,\s_i \|-> \sgm''(\s_i)]}
}}\\[2ex]
...
%TODO should fix??	
\PRule{X-Termi}{\PT{\Axiom{\sevalf {\a_1} {\a_k} \emptyv \emptyv}}}
...
According to this definition, it is only meaningful to have $\S  \subseteq dom(\sgm_1)$ (or $dom(\sgm_2)$), and $\S$ can be empty. 
