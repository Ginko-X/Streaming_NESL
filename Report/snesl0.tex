...
Draft version \versionnumber: (almost) finished the proof of the main correctness theorem and the built-in function correctness theorem.
...
\begin{lem} \label{lem-sgm-join}
	...
	then $\seval{p}{\sgm_1 \x{\st} \sgm_2}{\a_1 \++ \a_2}{\sgm_1' \x{} \sgm_2'}$
\end{lem}
