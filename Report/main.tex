...
\def\*#1{\mathbf{#1}}
\def\mysnesl{$\mathrm{SNESL_1} \ $}
\def\fmsnesl{$\mathrm{SNESL_0} \ $}
\def\fmsvcode{$\mathrm{SVCODE_0} \ $}
...
\begin{abstract}
 ...
 Two execution models of the extended SVCODE, the traditional eager one and the streaming one, are given and discussed.
 
 Then, for a subset of SNESL, we show the formalization of the semantics of the source and target languages, and the proof of the translation correctness and work cost preservation.
