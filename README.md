...
+ Week 29 (17 Jul ~ 23 Jul)
    + Modified the scheduling strategy from _looping scheduling_ (mentioned in #19) to some "fully-filled" looping scheduling, to maintain the correctness of cost model
	...
	+ will be modified further to the two-phase scheduling discussed in #19
